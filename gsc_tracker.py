...
# Constants
SITE_URL = 'sc-domain:lawncare.center'  # Domain property format
...
BASE_URL = 'https://lawncare.center'
...
def generate_report(indexed, not_indexed, opportunities, output_json=False):
    ...
    print("\n" + "="*60)
    print("📊 GSC TRACKING REPORT - lawncare.center")
    print("="*60)
...
def main():
    parser = argparse.ArgumentParser(description='GSC Tracking for lawncare.center')
